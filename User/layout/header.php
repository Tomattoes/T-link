            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small">
                        <li><a class="dropdown-item" href="foto.php"><i class="bi bi-plus"></i> Create</a></li>
                        <li><a class="dropdown-item" href="album.php"><i class="bi bi-images"></i> Album</a></li>
                        <li><a class="dropdown-item" href="profile.php"><i class="bi bi-people"></i> Profile</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="../sign-out.php"><i class="bi bi-box-arrow-right"></i> Sign out</a></li>
                    </ul>
                </div>
            </div>
        </div>
